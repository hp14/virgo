...
/*	(function() {
		...
		if($('.single-image').length) {
			...
			$('.single-image.picture-icon').on("click", function(){window.location.href= $(this).attr('href');  	});
...
$('.pdb').parent().css({"display": "inline-block"});
$('.pdb').css({"color": "#0632c9"});
	$('.pdb').hover(function(event) {
		//console.log($(this).closest('.popup'));
		var a_link= $(this).offset();
		//$(this).html("X: " + event.pageX + ", a_link: " +  a_link.left);
		$(this).parent().find('#myPopup').addClass('show');

		var popover_span= $(this).next().offset();
		$(this).mouseout(function(event){

			//$(this).html("X: " +  a_link.top + ", Y: " + popover_span.top);
			//alert(event.pageY +'------'+ x.top);
			if( (event.pageY -10) > a_link.top  ){
				$(this).parent().find('#myPopup').removeClass('show');
			}else if( (event.pageX -50) > a_link.left ){
							$(this).parent().find('#myPopup').removeClass('show');
			}
	...
	$('.popuptext').hover(function() {
		...
		var popover_span= $(this).offset();
		$(this).mouseout(function(event){
			// $(this).html("X: " + event.pageX + ", Y: " + event.pageY);
			//$(this).html("X: " +  a_link.top + ", Y: " + popover_span.top);
			//alert(event.pageY +'------'+ x.top);
			//if( (event.pageY -10) < popover_span.top ){
			$('.popuptext').removeClass('show');
			//}
		});
	});

function scroll_v (element){
